...
class _ExpenseListviewState extends State<ExpenseListview> {
  ...
  ValueNotifier<List<TransactionModel>> selectedList = TransactionDB.instance.expenseTransactionListNotiFier;
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Slidable(
                      endActionPane:
                        ...
                        SlidableAction(
                          backgroundColor:
                              const Color.fromARGB(255, 210, 208, 202),
                          onPressed: (index) {
